...
## ChiliPeppr Widget / XYZ Axes v2 - RIX
  ...
  function() {
    ...
    cprequire(
      ...
      function(myObjWidgetXyz) {
        ...
        console.log("Widget / XYZ Axes v2 - RIX just got loaded.", myObjWidgetXyz);
        myObjWidgetXyz.init();
      }
    );
  }
